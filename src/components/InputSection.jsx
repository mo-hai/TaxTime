...
const InputSection = ({ onCalculate }) => {
  ...
  const handleCalculateClick = () => {
    onCalculate({
      ...
      isInnovativeBusiness: formData.isInnovativeBusiness,
        ...
        <div className="input-right">
          ...
          <div className="checkbox-group">
            <label>
              <input
                type="checkbox"
                checked={formData.isInnovativeBusiness}
                onChange={(e) => setFormData({...formData, isInnovativeBusiness: e.target.checked})}
              />
              Innovative Business
            </label>
          </div>
